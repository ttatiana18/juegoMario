...
class Jugador(pygame.sprite.Sprite):
	...
	def __init__(self, all_b_sprite):
		super().__init__()
		self.m=Recorte('mario.png',14,5)
		self.direccion=0
		self.con=0
		self.image=self.m[self.direccion][self.con]
		#self.image = pygame.image.load("sprite_mario_right.png").convert()
		self.image.set_colorkey((0,0,0))
		self.rect = self.image.get_rect()
...
if __name__ == '__main__': 
	...
	fondo=pygame.image.load('mapa2.png')
	info=fondo.get_rect()
	fondo_ancho=info[2]
	fondo_alto=info[3]

	plantilla_sprite=pygame.image.load(name_archivo)
	    ...
	    for event in pygame.event.get():
	        ...
	        if event.type == pygame.KEYDOWN:
	        	...
	        	if event.key == pygame.K_RIGHT:
	        		jugador.image = pygame.image.load("sprite_mario_right.png").convert()
	        		jugador.vel_x = 5
	        	if event.key == pygame.K_LEFT:
	        		jugador.image = pygame.image.load("sprite_mario_left.png").convert()
	        		jugador.vel_x = -5
